...
async def on_message(message):
    ...
    #conversational:
    #wordy
    if message.content.startswith("j!say "):
        userInput = message.content[6:]
        await message.channel.send(userInput)
    if message.content.startswith("j!general "):
        userInput = message.content[10:]
        channel = client.get_channel(677582115440820247)
    ...
    if message.content.startswith("j!i love you") or message.content.startswith("j!ily"):
    ...
    if message.content.startswith("j!go to sleep") or message.content.startswith("j!go to bed") or message.content.startswith("j!transhuman") or message.content.startswith("j!cyberpunk") or message.content.startswith("j!pipe dream"):
    ...
    if message.content.startswith("j!nom") or message.content.startswith("j!bite"):
    ...
    if message.content.startswith("j!disappointed") or message.content.startswith("j!unamused") or message.content.startswith("j!rape")  or message.content.startswith("j!nigger"):
